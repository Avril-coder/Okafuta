...
export const CableTvTab: React.FC<CableTvTabProps> = ({
  ...
  const mockBillList = [
    { id: '1', timestamp: '2023-10-27 15:00', provider: 'DStv Namibia', amount: 'N$ 600.00', status: 'Completed' },
    { id: '2', timestamp: '2023-10-27 10:30', provider: 'GOtv Nigeria', amount: '₦ 3500.00', status: 'Completed' },
    { id: '3', timestamp: '2023-10-26 17:00', provider: 'DStv South Africa', amount: 'R 450.00', status: 'Pending' },
  ];
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage your cable TV subscriptions with ease.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <form onSubmit={handleContinue} className="space-y-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="customer-account">Smart Card Number</Label>
              <Input
                id="customer-account"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Your history of cable TV payments.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
