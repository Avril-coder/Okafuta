...
export const WaterTab: React.FC<WaterTabProps> = ({
  ...
  const mockBillList = [
    { id: '1', timestamp: '2023-10-27 13:00', provider: 'City of Windhoek Water', amount: 'N$ 250.00', status: 'Completed' },
    { id: '2', timestamp: '2023-10-27 09:30', provider: 'Lagos Water Corp', amount: '₦ 2000.00', status: 'Completed' },
    { id: '3', timestamp: '2023-10-26 14:00', provider: 'Joburg Water', amount: 'R 100.00', status: 'Pending' },
  ];
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Settle your water bills quickly and easily.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <form onSubmit={handleContinue} className="space-y-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="customer-account">Account/Reference Number</Label>
              <Input
                id="customer-account"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Your history of water payments.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
