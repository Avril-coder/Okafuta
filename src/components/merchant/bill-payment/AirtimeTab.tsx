...
export const AirtimeTab: React.FC<AirtimeTabProps> = ({
  ...
  const mockBillList = [
    { id: '1', timestamp: '2023-10-27 14:30', customer: '264811234567', provider: 'MTC', amount: 'N$ 50.00', status: 'Completed' },
    { id: '2', timestamp: '2023-10-27 10:15', customer: '2348012345678', provider: 'MTN NG', amount: '₦ 1000.00', status: 'Completed' },
    { id: '3', timestamp: '2023-10-26 18:00', customer: '27821234567', provider: 'Vodacom', amount: 'R 20.00', status: 'Pending' },
  ];
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <form onSubmit={handleContinue} className="space-y-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="customer-account">Customer Account/Phone Number</Label>
              <Input
                id="customer-account"
